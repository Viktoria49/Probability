...
# Ответ:
# t-наблюдаемое 0.563 не заходит за границы правостороннего критического значения
# t-табличного 1.833 Следовательно, нулевая гипотеза не опровергнута и значимых статистических
# различий между m1 2.528 и m0 2.5 нет.
# Партия изготавливается со средним арифметическим 2.5
